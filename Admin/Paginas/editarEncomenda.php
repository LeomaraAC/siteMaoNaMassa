       ...
       <div class="contornoDiv row">
           ...
           <div class="form-inline">
               ...
               <div class="form-group">
                   ...
                   <input type="text" class="form-control" id="dataEnc" name="dataEnc" value="<?php $date = new DateTime($linha["dataEncomenda"]); echo $date->format('d/m/Y');?>" size="7" readonly>
               </div>
               <div class="form-group">
        ...
        <div class="contornoDiv row">
            ...
            <div class="form-inline">
                ...
                <div class="form-group col-sm-9">
                    ...
                    <input type="text" class="form-control" id="nomeCli" name="nomeCli" value="<?php echo $linha["cliente"] ?>" size="80" readonly>
                </div>
            </div>
        </div>
        <div class="contornoDiv row">
            ...
            <div class="form-inline">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="cel" name="cel" value="<?php echo  empty($linha["cel"]) ? "--" : $linha["cel"]?>" size="15" readonly>
                </div>
                <div class="form-group">
                    <label for="tel">Telefone:</label>
                    <input type="text" class="form-control" id="tel" name="tel" value="<?php echo  empty($linha["tel"]) ? "--" : $linha["tel"]?>" size="15" readonly>
                </div>
                <div class="form-group">
                    <label for="email">E-mail</label>
                    <input type="email" class="form-control" id="email" name="email" size="35" value="<?php echo  empty($linha["email"]) ? "--" : $linha["email"]?>" readonly>
                </div>
            </div>
        </div>
        <div class="contornoDiv row">
            ...
            <div class="form-inline">
                ...
                <div class="form-group col-sm-9">
                    ...
                    <input type="text" class="form-control" id="rua" name="rua" value="<?php echo $endereco["rua"]?>">
                </div>
                <div class="form-group">
                    <label for="tel">Número:</label>
                    <input type="text" class="form-control" id="numero" name="numero" value="<?php echo $endereco["numero"]?>" size="5">
                </div>
            </div>
            <div class="form-inline">
                <div class="form-group">
                    <label for="bairro">Bairro:</label>
                    <input type="text" class="form-control" id="bairro" name="bairro" size="35" value="<?php echo $endereco["bairro"]?>">
                </div>
                <div class="form-group">
                    <label for="cidade">Cidade:</label>
                    <input type="text" class="form-control" id="cidade" name="cidade" size="35" value="<?php echo $endereco["cidade"]?>">
                </div>
            </div>
        </div>
        ...
        <div class="contornoDiv row">
            ...
            <textarea name="observacoes" id="observacoes"><?php echo $linha["Observacao"]?></textarea>
        </div>
